...
use gio::prelude::*;
use gtk::prelude::*;
use gtk::{ApplicationWindow, Label, ListStore, Orientation, TreeView, TreeViewColumn,
          WindowPosition};
...
fn main() {
    ...
    let application =
        gtk::Application::new("com.github.simple_treeview", gio::ApplicationFlags::empty())
